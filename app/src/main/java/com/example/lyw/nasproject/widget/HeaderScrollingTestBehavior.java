 ...
 */
public class HeaderScrollingTestBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    ...
    public HeaderScrollingTestBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
