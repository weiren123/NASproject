...
public class TestActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        combineChart = (CombineChart) findViewById(R.id.combine_chart);
    ...
    private void initData() {
        ...
        combineChart.getAxisLeft().setAxisPosition(LEFT_OUTSIDE);
        combineChart.getAxisRight().setAxisPosition(RIGHT_INSIDE);
        combineChart.setMaxVisibleEntryCount(20);
        combineChart.setHighlightColor(Color.BLACK);
//        combineChart.setOnHighlightStatusChangeListener(highlightStatusChangeListener);
        combineChart.setDataSet(new CandlestickDataSetArrowDecorator(dataSet));
    }
}
